...
class ChromaticAberration extends Object {
  #_id = null;
  #_name = "";
  #_meta = {};
...
if (!LXRN.Postprocessing) {
  LXRN.Postprocessing = {};
}
LXRN.Postprocessing.ChromaticAberration = ChromaticAberration;

module.exports = ChromaticAberration;
